...
- **Improve hardware fidelity beyond observed ROM needs.** TX39 Config now
  ...
  NMI/ordinary-exception flags remain outside the interpreter's current event
  model. All four coprocessor condition inputs now implement ordinary and
  likely branches; no likely opcode occurs in a sized SDK ELF function.
