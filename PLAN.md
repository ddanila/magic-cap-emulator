...
- **Improve hardware fidelity beyond observed ROM needs.** TX39 Config now
  ...
  covering the ROM's slow/fast helpers and quarter-speed deep-doze loop.
  External-bus timing, per-instruction cycle costs, and many Dino registers
  remain behavioral rather than cycle-exact. The verified boot, power, sound,
