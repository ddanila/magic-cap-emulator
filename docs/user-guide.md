...
| Telephone and built-in modem | The built-in fax modem uses a telephone line and supports tone/pulse configuration (pp. 135–163, 216) | ROM V.32 code and continuous telecom DMA execute; Betty connected/off-hook and Dino ring-level/edge behavior pass a direct DAA regression | Internal ROM/DSP and digital DAA boundaries covered; dial tone, carrier, remote peer, pulse dialing and fax are missing |
