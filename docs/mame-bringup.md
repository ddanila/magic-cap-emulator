...
product-side PPP input, LCP negotiation and the first IPCP address-assignment
transition. Artifacts remain under
...
still incomplete. The current gaps include completing IPCP and supplying a
