...
still incomplete. The current gaps include reporting the product's now-paired
Internet Center V.32 carrier into its PPP status callback, multi-device Magic
Bus topology, and hardware fidelity beyond the register behavior exercised by
the ROM; see
